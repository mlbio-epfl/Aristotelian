...
class TestHelperFunctions:
    ...
    def test_prh_metric_spec_lcs_knn_max_value(self):
        """prh_metric_spec for lcs_knn should have max_value = topk."""
        _, max_val = prh_metric_spec("lcs_knn", topk=10)
        assert max_val == 10.0

        _, max_val = prh_metric_spec("lcs_knn", topk=5)
        assert max_val == 5.0
